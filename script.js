...
function generatePassword() {
    ...
    var passwordLength = prompt("Provid a number between 8 and 128 characters");
...
password = confirm ("Do you want to use numbers in your password?")
...
password = confirm ("Do you want to use lowercase letters in your password?")
...
password = confirm ("Do you want to use uppercase letters in your password?")
